...
class Dinossauro:
    def __init__(self):
        ...
        self.imagem = pygame.image.load("ferrari.png")
        self.imagem = pygame.transform.scale(self.imagem, (50, 60))  # Redimensiona a imagem
...
class Cacto:
    def __init__(self):
        ...
        self.imagem = pygame.image.load("pare.png")
        self.imagem = pygame.transform.scale(self.imagem, (60, 70))  # Redimensiona a imagem
        self.rect = self.imagem.get_rect()
